...
public class BackCameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public <camera> BackCameraPreview(Functions cameraFunctions, Camera mBackCamera) {
                super(cameraFunctions, (AttributeSet) mBackCamera);
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        ...
        setFocus(String.valueOf(Camera.Parameters.FOCUS_MODE_AUTO));
        ...
        try {
            ...
            mCamera.setDisplayOrientation(setCameraDisplayOrientation((Activity) mContext, 0));
            ...
            new Handler().postDelayed(() -> {
                try {
                    ...
                    ExceptionUtility.logError(TAG, "After 2000 mils BackCameraPreview:::::::::::::::::::::::::", ex);
                }
            }, 2000);
            ExceptionUtility.logError(TAG, "BackCameraPreview", e);
        }
    }
